...
export function AdminCandidateDetail() {
  ...
  return <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-10">
    <button onClick={() => navigate('/admin/candidates')} className="mb-5 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground"><ArrowLeft className="h-4 w-4" />返回候选人列表</button>
