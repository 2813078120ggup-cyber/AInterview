...
- 空数据库：Flyway 执行 `V1__baseline_schema.sql`，再按顺序执行 V9–V26。
- 已存在且非空的历史数据库：首次启动会以 V8 建立基线，再执行 V9–V26。
...
1. 在 `backend/src/main/resources/db/migration/` 新建 `V27__<英文描述>.sql`；已发布或已进入待发布基线的 V1、V9–V26 不再修改。
