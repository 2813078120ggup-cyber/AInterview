...
| Web 前端 | React 19、TypeScript、Vite、Tailwind CSS 4、React Router、Radix UI、Framer Motion、Lucide、mpegts.js、PDF.js | [当前前端](03-当前前端.md) |
...
- 学习资料 PDF 由后端权限接口提供内容，前端仅保存批注坐标和笔记请求，不将 PDF 文件复制到 `public/` 或构建产物。
